                             ...
                             int *vetRotaAux2)
{
    ...
    cout<<"Inicio restricoes todo cliente tem que ser vizitado 1 vez\n";
    for(int h = 0; h < NumVeiculos; ++h)
    {
        if(h == 0)
        {
        ...
        {
            cout<<vetClienteRotaAux[i].cliente<<' ';
        }
    ...
    cout<<"Depois restricoes todo cliente tem que ser vizitado 1 vez\n";
    for(int h = 0; h < NumVeiculos; ++h)
    {
        if (h == 0)
        {
